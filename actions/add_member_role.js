module.exports = {
	...
	subtitle: function(data) {
		const roles = ["Wspomniana rola", "Pierwsza rola autora", "Pierwsza rola serwera", "Zmienna temp", "Zmienna serwerowa", "Zmienna globalna"];
		const channels = ["Wspomniany użytkownik", "Autor polecenia", "Zmienna temp", "Zmienna serwerowa", "Zmienna globalna"];

...
Obraz źródłowy:<br>
	...
	Lokalny adres URL czcionki (poprawny format: ttf):<br>
	<input id="fontPath" class="round" type="text" value="fonts/"><br>
	Wyrównanie:<br>
	<select id="align" class="round" style="width: 90%;">
		<option value="0" selected>U góry z lewej</option>
		<option value="1">U góry w środku</option>
		<option value="2">W prawym górnym rogu</option>
		<option value="3">Z lewej strony</option>
		<option value="4">Middle Center</option>
		<option value="5">Middle Right</option>
		<option value="6">Na dole po lewej</option>
		<option value="7">Dolny środek</option>
		<option value="8">Prawy dolny</option>
	</select><br>
	Oś x (prawo - lewo):<br>

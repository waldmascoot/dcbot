...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Obiekt członka</option>
			<option value="1">ID Użytkownika</option>
			<option value="2">Nazwa użytkownika</option>
			<option value="3">Wyświetlana nazwa użytkownika</option>
			<option value="4">Kolor użytkownika</option>
			<option value="15">Status użytkownika</option>
			<option value="16">URL awatara użytkownika</option>
			<option value="5">Member Server</option>
			<option value="6">Ostatnia wiadomość użytkownika</option>
			<option value="17">Lista ról użytkownika</option>
			<option value="7">Najwyższa rola użytkownika</option>
			<option value="8">Member Hoist Role</option>
			<option value="9">Rola koloru użytkownika</option>
			<option value="10">Czy użytkownik jest właścicielem?</option>
			<option value="11">Czy użytkownik jest wyciszony?</option>
			<option value="12">Member Is Deafened?</option>
      <option value="13">Czy może zostać zbanowny</option>
      <option value="14">Nazwa gry/statusu użytkownika</option>
      <option value="30">Niestandardowy status użytkownika</option>
      <option value="17">Lista ról użytkownika</option>
      <option value="18">Liczba ról użytkownika</option>
      <option value="19">Member Voice Channel</option>
      <option value="20">Member Discriminator</option>
      <option value="21">Tag użytkownika</option>
      <option value="22">Data utworzenia konta</option>
      <option value="23">Data utworzenia konta Timestamp</option>
      <option value="24">Data dołączenia</option>
      <option value="25">Data dołaczenia Timestamp</option>
      <option value="26">Identyfikator ostatniej wiadomości</option>
      <option value="27">Lista uprawnień</option>

...
Maksymalny czas (milisekundy):<br>
    ...
    <div style="padding-top: 8px;">
		...
		W odpowiedzi:<br>
            <select id="iftrue" class="round" onchange="glob.onChangeTrue(this)">
					 <option value="0" selected>Kontynuuj</option>
					 <option value="1">Zatrzymaj sekwencję akcji</option>
					 <option value="2">Przejdź do akcji</option>
    ...
    <div style="padding-top: 8px;">
		...
		Po limit czasu:<br>
            <select id="iffalse" class="round" onchange="glob.onChangeFalse(this)">
				<option value="0">Kontynuuj</option>
				<option value="1" selected>Zatrzymaj sekwencję akcji</option>
				<option value="2">Przejdź do akcji</option>
				<option value="3">Pomiń następne akcje</option>
		 </select>
        </div>

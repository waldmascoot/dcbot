...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Czy Bot może mówić?</option>
			<option value="1">Czy Bot może dołączyć do VC?</option>
			<option value="2">Czy bot może usunąć VC?</option>
			<option value="3">Pozycja na liście VC</option>
			<option value="4">Połączeni członkowie</option>
		</select>
	</div>
</div><br>
<div>

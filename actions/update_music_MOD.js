...
<div>
	<p>
		<u>Warning:</u><br>
		Ta czynność aktualizuje wersję ytdl-core do najnowszej wersji.<br>
		...
		Aktualizacja powinna naprawić rzeczy związane z adresem URL Play w YouTube.<br><br>
...
action: function(cache) {
	...
	console.log(require('child_process').execSync('npm install --save ytdl-core'));

...
<div style="padding-top: 8px;">
	...
	Źródło Emoji:<br>
		<select id="emoji" name="second-list" class="round" onchange="glob.onChange1(this)">
			<option value="4" selected>Normalna emoji</option>
			<option value="0">Niestandardowa emoji</option>
			<option value="1">Zmienna temp</option>
			<option value="2">Zmienna serwerowa</option>
			<option value="3">Zmienna globalna</option>
		</select>
	</div>
	<div id="varNameContainer2" style="float: right; width: 60%;">
		<span id="extName">Emotikony (prawy przycisk myszy -> Insert Emoji)</span>:<br>
	...
	init: function() {
		...
		glob.onChange1 = function(event) {
			...
			if(value === 0) {
				...
				varNameInput.innerHTML = "Emotikony (prawy przycisk myszy -> Insert Emoji)";
				document.getElementById("varNameContainer3").style.display = "none";
				document.getElementById("varNameContainer2").style.display = null;
			} else {

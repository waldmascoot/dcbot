...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			...
			<option value="3">Czy może wyrzucać?</option>
			<option value="4">Czy jest botem?</option>
			<option value="6">Data utworzenia konta</option>
			<option value="5">Nazwa(#0001)</option>

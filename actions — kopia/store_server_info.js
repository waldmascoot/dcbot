...
<div>
	<div style="padding-top: 8px; width: 70%;">
      ...
      <option value="17">Liczba członków serwera</options>
      ...
      <option value="7">Domyślny kanał serwera</options>
      <option value="9">Kanał systemu serwera</options>
      <option value="43">Filtr zawartości jawnej serwera</options>
      <option value="8">Kanał AFK serwera</options>
      <option value="19">Limit czasu AFK serwera</options>
      <option value="10">Domyślna rola serwera</options>
      <option value="48">Identyfikator właściciela serwera</options>
      ...
      <option value="22">Data dołączenia do serwera</options>
      <option value="20">Serwer dostępny?</options>
      <option value="21">Server Large</options>
      <option value="40">Serwer zweryfikowany?</options>
      <option value="23">Liczba kanałów serwera</options>
      <option value="13">Lista kanałów serwera</options>
      <option value="31">Lista identyfikatorów kanałów serwera</options>
      <option value="37">Liczba ról serwera</options>
      <option value="14">Lista ról serwera</options>
      <option value="32">Lista identyfikatorów ról serwera</options>
      <option value="30">Liczba botów serwera</options>
      <option value="35">Liczba ludzi na serwerze (bez botów)</options>
      <option value="15">Lista członków serwera</options>
      <option value="33">Lista identyfikatorów członków serwera</options>
      <option value="16">Lista emotikonów serwera</options>
      <option value="24">Liczba emotikonów na serwerze</options>
      <option value="25">Server Embed Enabled</options>
      <option value="27">Członkowie serwera online Count</options>
      <option value="29">Liczba niedostępnych członków serwera</options>
      <option value="26">Liczba członków serwera Nie przeszkadzać</options>
      <option value="28">Liczba członków offline serwera</options>
      <option value="38">Liczba kanałów tekstowych serwera</options>
      <option value="39">Liczba kanałów głosowych serwera</options>
      <option value="41">Lista banów</options>
      <option value="42">Lista zaproszeń do serwera</options>
      ...
      <option value="50">Identyfikator kanału widżetu serwera</options>
		</select>
	</div>
</div><br>
<div>

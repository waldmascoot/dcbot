...
<div>
	...
	Informacje o:<br>
		<select id="info" class="round">
			<option value="0" selected>Pozycja na liście ról</option>
			<option value="1">Data utworzenia</option>
			<option value="2">Zarządzana rola bota</option>
			<option value="5">Może bot edytować tę rolę?</option>
			<option value="3">Członkowie roli</option>
			<option value="4">Liczba członków roli</option>
			<option value="6">Obiekty członków ról</option>
			<option value="7">Identyfikatory członków roli</option>
		</select>
	</div>
</div><br>
<div>

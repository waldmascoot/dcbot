...
<div>
	...
	Informacje o:<br>
		<select id="info" class="round">
			<option value="0">Liczba członków nie przeszkadzać</option>
			<option value="1">Liczba członków online (naprawiona)</option>
			<option value="2">Liczba członków offline</option>
			<option value="3">Liczba członków zaraz wracam</option>

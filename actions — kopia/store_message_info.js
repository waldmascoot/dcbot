...
<div>
	...
	Informacje o:<br>
		<select id="info" class="round">
			<option value="0" selected>Obiekt wiadomości</option>
			<option value="1">ID wiadomości</option>
			<option value="2">Wiadomość tekstowa</option>
			<option value="3">Autor wiadomości</option>
			<option value="4">Kanał wiadomości</option>
			<option value="5">Sygnatura czasowa wiadomości</option>
			<option value="6">Wiadomość jest przypięta?</option>
      <option value="7">Wiadomość to TTS?</option>
      <option value="8">Lista załączników wiadomości</option>
			<option value="9">Treść wiadomości</option>
			<option value="12">Liczba reakcji wiadomości</option>
			<option value="13">Lista wspomnianych użytkowników wiadomości</option>
			<option value="14">Liczba wymienionych użytkowników wiadomości</option>
			<option value="15">Adres URL wiadomości</option>
			<option value="16">Data utworzenia wiadomości</option>
			<option value="17">Długość treści wiadomości</option>
			<option value="18">Liczba załączników wiadomości</option>
			<option value="19">Wiadomość Guild</option>
			<option value="20">Typ wiadomości</option>
			<option value="21">Identyfikator elementu webhook wiadomości</option>
			<option value="22">Wiadomość osadzona w embed</option>
		</select>
	</div>
</div><br>
<div>

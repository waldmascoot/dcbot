...
<div>
	<div style="padding-top: 8px; width: 70%;">
		...
		<select id="info" class="round">
			<option value="0" selected>Data utworzenia serwera</option>
			<option value="1">Użytkownikotrzymuje AFK po czasie?</option>
			<option value="2">Czy serwer jest dostępny?</option>
			<option value="4">Data dołączenia Bota</option>
			<option value="5">Ilość kanałów</option>
			<option value="6">Ilość Emoji</option>
			<option value="7">Embeds links?</option>
			<option value="9">Liczba członków online</option
			<option value="11">Liczba zaraz wracam członków</option>
			<option value="8">Liczba członków nie przeskadzać</option>
			<option value="10">Liczba członków offline</option>
			<option value="13">Identyfikatory kanałów serwera</option>
			<option value="14">Identyfikatory ról serwera</option>
			<option value="15">Identyfikatory członków serwera</option>
			<option value="16">Liczba botów</option>
			<option value="17">Liczba członków serwera(bez botów)</option>
			<option value="12">Łączna liczba botów na serwerach</option>
			</select>
	</div>
</div><br>
<div>

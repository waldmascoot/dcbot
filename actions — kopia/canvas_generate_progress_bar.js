...
<div style="padding-top: 8px;">
	...
	Rodzaj:<br>
		<select id="type" class="round" onchange="glob.onChange1(this)">
			<option value="0" selected>Podstawowy</option>
			<option value="1">Zaokrąglony</option><br>
		</select>
	</div>
</div><br><br><br>
<div style="padding-top: 8px;">
	<div style="float: left; width: 50%;">
		<div id="Change1text">Szerokość (px):</div>
		<input id="width" class="round" type="text"><br>
	</div>
	<div style="float: right; width: 50%;">
		<div id="Change2text">Wysokość (px):</div>
...
init: function() {
	...
	glob.onChange1 = function(event) {
		...
		if (event.value === "0") {
			Change1text.innerHTML = "Wysokość::";
			Change2text.innerHTML = "Wysokość:";

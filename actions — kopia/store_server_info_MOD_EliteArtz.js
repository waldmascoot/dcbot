...
<div>
	...
	Informacje o :<br>
		<select id="info" class="round">
			<option value="0" selected>Identyfikatory kanałów serwera(ID)</option>
			<option value="1">Identyfikatory ról serwera(ID)</option>
			<option value="2">Identyfikatory członków serwera(ID)</option>
		</select>
	</div>
</div><br>
<div>
